        ...
        <div class="page-inner">
          <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
            <div>
              ...
              <h6 class="op-7 mb-2">Main Dashboard</h6>
            </div>
            <div class="ms-md-auto py-2 py-md-0">
              <a href="inventory.php" class="btn btn-label-info btn-round me-2">Manage</a>
              <a href="add-customer.php" class="btn btn-primary btn-round">Add Customer</a>
            </div>
          </div>
          <?php   include "./widgets/details.php"?>
         <!-- stats -->
